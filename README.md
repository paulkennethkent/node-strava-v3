...
- `strava.athlete.listActivities(args,done)` _Get list of activity summaries_
...
- `strava.athletes.get(args,done)` _Get a single activity. args.id is required_
...
- `strava.streams.cadence(args,done)`
